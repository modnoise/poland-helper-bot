...
from application.services.openai.roles.agent_adaptation.prompt import PROMPT


@dataclass
class AgentAdaptationRelocation(AIRole):
    ...
    def load_role(user_language: str):
        ...
        role_id = RoleEnum.AGENT_ADAPTATION_RELOCATION
        data_file_name = "agent_adaptation.pdf"
        llm = ChatOpenAI(temperature="0", model="gpt-4o")
        ai_prefix = "Agent"

        return AgentAdaptationRelocation(
            prompt=prompt,
